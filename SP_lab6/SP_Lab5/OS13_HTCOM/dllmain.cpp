...
const wchar_t* g_szFriendlyName = L"OS14.ComHT";    // Дружественное имя компонента
const wchar_t* g_szVerIndProgID = L"OS14.ComHT.1.0";      // Не зависящий от версии ProgID
const wchar_t* g_szProgID = L"OS14.CompHT.1";              // ProgID

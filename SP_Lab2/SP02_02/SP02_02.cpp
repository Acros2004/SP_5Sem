...
int main()
{
	...
	CoInitialize(NULL);//NULL- настройки по умолчанию
	HRESULT hr0 = CoCreateInstance(CLSID_Math, NULL, CLSCTX_INPROC_SERVER, IID_IUnknown, (void**)&pIUnknown);//null - агрегация

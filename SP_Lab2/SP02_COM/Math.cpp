...
HRESULT STDMETHODCALLTYPE Math::QueryInterface(REFIID riid, void** ppv) //riid - id интерфейса, указатель на интерфейс
{ 
	if (riid == IID_IUnknown || riid == IID_IAdder) //почему-то отдельно IUnknown неодназначный 
		*ppv = (IAdder*)this;

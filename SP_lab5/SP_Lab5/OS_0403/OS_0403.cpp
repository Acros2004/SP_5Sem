...
#ifdef _WIN64
#pragma comment(lib, "C:/Users/nikit/Desktop/univer/3cource1sem/SP/SP_lab5/SP_Lab5/x64/Debug/OS13_HTCOM_LIB.lib")
#else
...
int main(int argc, char* argv[])
{
	try
	{
		...
		if (argc > 1) {
			...
			path = "C:/Users/nikit/Desktop/univer/3cource1sem/SP/SP_lab5/table/table.ht";
			ht = OS13_HTCOM::HT::open(h, L"C:/Users/nikit/Desktop/univer/3cource1sem/SP/SP_lab5/table/table.ht", true);
		}
		if (ht) {
		...
		while (WaitForSingleObject(event, 0) == WAIT_TIMEOUT) {
			...
			if (OS13_HTCOM::HT::remove(h,ht, element)) {
